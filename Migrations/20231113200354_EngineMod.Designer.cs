...
namespace VehicleData.Migrations
{
    ...
    [Migration("20231113200354_EngineMod")]
    partial class EngineMod
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VehicleData.Data.Models.Vehicle", b =>
                {
                    ...
                    b.HasOne("VehicleData.Data.Models.Engine", "DisplacementNavigation")
                        .WithMany("Vehicles")
                    ...
                    b.Navigation("DisplacementNavigation");
